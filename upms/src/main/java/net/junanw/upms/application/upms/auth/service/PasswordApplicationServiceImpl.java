...
import net.junanw.upms.core.identity.password.ChangePasswordCommand;
import net.junanw.upms.core.identity.password.ChangePasswordProcessor;
import net.junanw.upms.core.identity.password.model.request.ResetPasswordRequest;
import net.junanw.upms.core.identity.password.ResetPasswordCommand;
import net.junanw.upms.core.identity.password.ResetPasswordProcessor;
