package net.junanw.upms.system.iam.user.controller;
...
import net.junanw.upms.system.iam.user.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<byte[]> export(
        ...
        List<UserPageItem> items = userService.export(username, realName, mobile, orgName, status, startTime, endTime);
