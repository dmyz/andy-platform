...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleBadRequestException(Exception exception) {
        log.warn("坏请求参数异常: {}", exception.getMessage());
        return failure(400, "请求参数不合法");
    }
