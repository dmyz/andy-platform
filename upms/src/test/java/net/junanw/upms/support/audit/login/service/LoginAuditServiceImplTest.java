...
import net.junanw.upms.support.audit.login.repository.LoginAuditEventRepository;
import net.junanw.upms.system.iam.account.entity.AccountEntity;
import net.junanw.upms.system.iam.account.repository.AccountRepository;
import net.junanw.upms.system.iam.user.entity.UserEntity;
import net.junanw.upms.system.iam.user.repository.UserRepository;
...
class LoginAuditServiceImplTest extends IntegrationTestBase {
    ...
    @Test
    void pageShouldUseJpaPagingForBaseFilters() {
    ...
    @Test
    void exportShouldReuseAuditRepositoryFilters() {
    ...
    private void saveUser(Long id, String userCode, String displayName, String employeeNo) {
        ...
        entity.setCreatedAt(LocalDateTime.of(2026, 4, 4, 0, 0));
        entity.setUpdaterId(10001L);
        entity.setUpdatedAt(LocalDateTime.of(2026, 4, 4, 0, 0));
    ...
    private void saveLoginEvent(Long id, Long userId, String accountIdentifier, String authType, boolean success, LocalDateTime eventTime) {
        ...
        loginAuditEventRepository.saveAndFlush(entity);
    }
}
